...
def main(docpath, name, mergetype, authortype, author, email, docnamespace, filetype, outpath = None):
    ...
    doc = create_merged_spdx_document(doc_list, docnamespace, name, authortype, author, email, merge_type)
